...
def handler(event, context):
    ...
    try:
        ...
        if not phone or not password:
            return {'statusCode': 400, 'body': json.dumps({'message': 'برجاء إدخال البيانات'})}
        ...
        # 2. الترحيل (استخدام الـ Enc ID الثابت لضمان العمل)
        ...
        if res.status_code in [200, 201, 202]:
            ...
            return {'statusCode': 400, 'body': json.dumps({'message': 'الحساب غير مؤهل للترحيل حالياً'})}
